...
const init = {
    ...
    eventTicket: {
        headerFields:   [{ key:"nextGame",   label:"NEXT GAME",
...
export default function CreatePass() {
    ...
    return (
        <form onSubmit={submit} style={{ maxWidth: 400, margin: '2em auto', fontFamily: 'sans-serif' }}>
            ...
            <Field label="Header Value"    path="eventTicket.headerFields.0.value"     type="datetime-local" data={data} set={setData}/>
            <Field label="Header DateStyle"path="eventTicket.headerFields.0.dateStyle" type="text"           data={data} set={setData}/>

            <h3>Primary Field</h3>
            <Field label="Primary Label"   path="eventTicket.primaryFields.0.label"   type="text" data={data} set={setData}/>
            <Field label="Primary Value"   path="eventTicket.primaryFields.0.value"   type="text" data={data} set={setData}/>

            <h3>Secondary Fields</h3>
            <Field label="Sec 1 Label"     path="eventTicket.secondaryFields.0.label"       type="text" data={data} set={setData}/>
            <Field label="Sec 1 Value"     path="eventTicket.secondaryFields.0.value"       type="text" data={data} set={setData}/>
            <Field label="Sec 2 Label"     path="eventTicket.secondaryFields.1.label"       type="text" data={data} set={setData}/>
            <Field label="Sec 2 Value"     path="eventTicket.secondaryFields.1.value"       type="text" data={data} set={setData}/>
            <Field label="Sec 2 Alignment" path="eventTicket.secondaryFields.1.textAlignment" type="text" data={data} set={setData}/>

            <h3>Auxiliary Fields</h3>
            <Field label="Block"           path="eventTicket.auxiliaryFields.0.value" type="text" data={data} set={setData}/>
            <Field label="Row"             path="eventTicket.auxiliaryFields.1.value" type="text" data={data} set={setData}/>
            <Field label="Seat"            path="eventTicket.auxiliaryFields.2.value" type="text" data={data} set={setData}/>
